...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    private boolean lineIndicator = true;
    ...
    public static void removeGlobalOnLayoutListener(ViewTreeObserver mViewTreeObserver, OnGlobalLayoutListener listener) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (lineIndicator) {
            ...
            canvas.drawRect(mid-TextSizePx.a(getContext(),10), height - indicatorHeight, mid+10, height, rectPaint);
        } else {
            rectPaint.setStyle(Style.FILL);
            Path path = new Path();
            float mid = (lineLeft + lineRight) * 0.5f;
    ...
    public void setLineIndicator(boolean bLineIndicator) {
        lineIndicator = bLineIndicator;
        invalidate();
    }
